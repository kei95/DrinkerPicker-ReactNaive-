...
class PlayerScreen extends React.Component {
    ...
    render() {
        ...
        if (this.props.isNotFirstTurn && this.state.isResult){
            return(
                <View style={styles.containerResult}>
                    <Result answer={this.state.answer} players={this.state.players} playersLeft={this.state.numOfPlayer} winner={this.state.result} gap={this.state.WinnersGap} winnersNum={this.state.WinnersNum} />
                </View>);
